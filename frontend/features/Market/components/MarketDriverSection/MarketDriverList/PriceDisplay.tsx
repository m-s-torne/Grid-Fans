...
export const PriceDisplay = ({ 
  ...
  const getStyles = () => {
    switch (type) {
      case 'buyout':
        return { bg: 'bg-orange-600/80', border: 'border-orange-400/60', text: 'text-orange-50', badge: '130%', badgeBg: 'bg-orange-700', icon: '🔥' };
      case 'sale':
        return { bg: 'bg-yellow-500/70', border: 'border-yellow-200/50', text: 'text-yellow-50', badge: null, badgeBg: '', icon: '💰' };
      case 'refund':
        return { bg: 'bg-red-500/70', border: 'border-red-200/50', text: 'text-red-50', badge: '80%', badgeBg: 'bg-red-700', icon: '💸' };
      default:
        return { bg: 'bg-green-500/70', border: 'border-green-200/50', text: 'text-purple-50', badge: null, badgeBg: '', icon: '💵' };
    }
  };
