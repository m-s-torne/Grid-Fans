...
import { useUserTeam } from '@/lib/hooks/userTeams';
import { useMarketStates } from '@/features/Market/hooks';
import { useParams } from 'next/navigation';
import type { BuyDriverResponse, BuyFromUserResponse, DriverWithOwnership, ListDriverResponse, SellDriverResponse } from '@/lib/types/marketTypes';
import type { ActiveTab, Dialog } from '@/features/Market/hooks/useMarketState';
import type { League } from '@/lib/services';
...
export interface MarketContextType extends MarketDataFetch, MarketMutations, DragAndDropVariables {
