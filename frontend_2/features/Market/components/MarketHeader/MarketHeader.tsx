        ...
        <div className="mb-6 sm:mb-8">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-2 sm:gap-4">
                    <div className="w-fit bg-gradient-to-br from-green-600/20 to-green-700/20 border border-green-500/50 rounded-lg sm:rounded-xl px-4 sm:px-6 py-2 sm:py-3 flex flex-col items-center">
